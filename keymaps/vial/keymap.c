...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├───┼───┼───┼───┼───┼───┼───┴───┼───┼───┼───┤      │
     * │  Esc │ Ctrl │  Alt │  Gui │  Fn  │ space│     space    │  Gui │  Alt │ Ctrl │      │
     * └───┴───┴───┴───┴───┴───┴───────┴───┴───┴───┴───┘
     */
    [0] = LAYOUT_30_36(
        ...
        KC_ESC,  KC_LCTL, KC_LALT, KC_LGUI, MO(1),   KC_SPC,  KC_SPC,           KC_RGUI, KC_RALT, KC_RCTL
    ),
    ...
    [1] = LAYOUT_30_36(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT,
